...
- [`../probes/smart_record_probe_handler.md`](../probes/smart_record_probe_handler.md) — SmartRecord probe handler — GstClockTime timing, stale cache, concurrent limit, session cleanup
